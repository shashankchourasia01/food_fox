...
const Footer = () => {
  ...
  const handleWhatsAppClick = (type) => {
    let message = '';
    if (type === 'help') {
      message = encodeURIComponent("Hi, I need help with the website. Can you assist me?");
    } else if (type === 'contact') {
      message = encodeURIComponent("Hi, I have a question about my order. Order ID: ");
    }
            ...
            <ul className="space-y-2 mt-3">
              <li>
                <button
                  ...
                  className="text-gray-400 hover:text-red-400 transition text-xs md:text-sm block w-full text-right"
                >
                  Help Center
                </button>
              </li>
